...
export const metadata: Metadata = {
  title: 'Política de Privacidad - PUNTOCLICK',
  description: 'Política de privacidad y protección de datos personales de PuntoClic.',
};
        ...
        <div className="space-y-lg">
          <section className="bg-surface-container-low rounded-xl p-md md:p-lg border border-surface-dim shadow-ambient">
            ...
            <p className="text-on-surface-variant mb-4">
              En PUNTOCLICK nos tomamos muy en serio la seguridad de tus datos personales. Toda la información recopilada se utiliza exclusivamente para brindar y mejorar el emparejamiento entre talentos, empresas e instituciones.
            </p>
          </section>
        </div>
      </main>
